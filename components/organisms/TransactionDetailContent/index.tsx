          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="purchase pt-30">
                ...
                <Row label="Your Game ID" value="masayashiro" />
              ...
              <div className="payment pt-10 pb-10">
                ...
                <Row label="Your Account Name" value="Masayashiro Yashuo" />
                <Row label="Type" value="Worldwide Transfer" />
                <Row label="Bank Name" value="Mandiri Syariah" />
                <Row label="Bank Account Name" value="PT. StoreGG Jepun" />
                <Row label="Bank Number" value="9878-3124-2077" />
              </div>
